...
export const ROUTES: RouteMeta[] = [
  ...
  },
  {
    ...
    type: 'service',
    title: {
      es: 'Automatización de Procesos con RPA en Panamá | Workflows',
      en: 'Process Automation with RPA in Panama | Digital Workflows',
    },
    description: {
      es: 'RPA, workflows digitales e integraciones entre sistemas, con reducción de 60-80% en tiempos. Primero optimizamos y luego automatizamos, para ROI real.',
      en: 'RPA, digital workflows and system integrations, with 60-80% time reduction. We optimize the process first and automate second, so the ROI is real.',
    },
  ...
  // ── Sistemas de calidad ──────────────────────────────────────
  {
    ...
    type: 'service',
    title: {
      es: 'Consultoría en Sistemas de Calidad ISO 9001 en Panamá',
      en: 'ISO 9001 Quality Management System Consulting in Panama',
    },
    description: {
      es: 'Implementación, auditoría y certificación ISO 9001 para banca, manufactura y servicios regulados. Certificación en 4-8 meses con 85%+ de aprobación.',
      en: 'ISO 9001 implementation, audit and certification for banking, manufacturing and regulated services. Certification in 4-8 months with 85%+ first-time approval.',
    },
    keyword: { es: 'sistemas de gestión de calidad', en: 'quality management systems' },
    updatedAt: '2026-02-02',
    priority: 0.8,
    changeFrequency: 'weekly',
  ...
  },
  {
    ...
    type: 'service',
    title: {
      es: 'Certificación ISO 9001 en Panamá | 85% Aprueba a la 1ª',
      en: 'ISO 9001 Certification in Panama | 85% Pass on First Try',
    },
    description: {
  ...
  // ── Gestión de proyectos ─────────────────────────────────────
  {
    ...
    type: 'service',
    title: {
      es: 'Gestión de Proyectos en Panamá | PMs Certificados PMP',
      en: 'Project Management in Panama | PMP Certified Managers',
    },
    description: {
      es: 'Tercerización de Project Managers PMP®, Scrum Masters y Directores de PMO. Se integran a tu equipo en días, no meses, con metodología y respaldo empresarial.',
      en: 'Outsourced PMP® Project Managers, Scrum Masters and PMO Directors. They join your team in days, not months, with proven methodology and company backing.',
    },
  ...
  },
  {
    ...
    type: 'service',
    title: {
      es: 'Digitalización de Procesos en Panamá | RPA y Workflows',
      en: 'Process Digitization in Panama | RPA and Digital Workflows',
    },
    description: {
      es: 'Automatiza procesos con RPA, workflows digitales e integraciones, y elimina el papel. Reducción de 40-60% en tiempos y equipos libres para lo estratégico.',
      en: 'Automate processes with RPA, digital workflows and integrations, and remove paper. 40-60% time reduction and teams freed up for strategic work.',
    },
    keyword: { es: 'digitalización de procesos', en: 'process digitization' },
    updatedAt: '2026-02-02',
    priority: 0.7,
    changeFrequency: 'monthly',
  ...
  },
  {
    ...
    type: 'industry',
    title: {
      es: 'Consultoría para Firmas de Servicios Profesionales Panamá',
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    description: {
      es: 'Consultores especializados en optimización de procesos, gestión de proyectos y transformación digital para el sector servicios en América Latina.',
      en: 'Consultants specialized in process optimization, project management and digital transformation for the services sector across Latin America.',
    },
