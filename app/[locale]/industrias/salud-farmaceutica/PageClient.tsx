  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: isEs
        ...
        : 'Experience in both. ISO 9001/13485: General quality management system. GMP (Good Manufacturing Practices): Specific requirements for pharmaceuticals/medical devices. Many companies implement ISO + GMP together (complementary). We have experience preparing pharmaceutical distributors for GDP (Good Distribution Practices) and GSP (Good Storage Practices) certification. If company requires GMP/GDP/GSP compliance, we design system that complies with local regulations.'
    },
    {
      question: isEs ? '¿Cómo Alternative maneja implementación sin afectar atención de pacientes?' : 'How does Alternative handle implementation without affecting patient care?',
      answer: isEs
        ? 'Metodología específica para 24/7: (1) Diagnóstico: Sin interrumpir, observamos operación, entrevistamos fuera de horas pico. (2) Diseño: Workshops con personal en horarios convenientes (no horas críticas). (3) Capacitación: Turnos múltiples (capacitamos personal de mañana, tarde, noche separadamente). (4) Go-live: Gradual por área (no toda institución simultánea), soporte intensivo primeras semanas. Objetivo: mejorar operación sin afectar pacientes.'
        : 'Specific methodology for 24/7: (1) Diagnosis: Without interrupting, we observe operation, interview outside peak hours. (2) Design: Workshops with staff at convenient times (not critical hours). (3) Training: Multiple shifts (we train morning, afternoon, night staff separately). (4) Go-live: Gradual by area (not entire institution simultaneously), intensive support first weeks. Objective: improve operation without affecting patients.'
    },
    {
      question: isEs ? '¿Certificación ISO en salud es reconocida por aseguradoras/reguladores?' : 'Is ISO certification in healthcare recognized by insurers/regulators?',
      answer: isEs
        ? 'Sí. ISO 9001 es reconocido internacionalmente. Aseguradoras: Muchas valoran ISO al negociar tarifas (demuestra calidad). Reguladores: Ministerio Salud ve ISO positivamente (aunque no reemplaza licencias sanitarias). Convenios corporativos: Empresas grandes prefieren clínicas certificadas ISO para convenios. Acreditaciones: ISO 9001 facilita acreditaciones hospitalarias (Joint Commission, ICONTEC). ISO no reemplaza cumplimiento sanitario obligatorio, pero complementa y facilita.'
