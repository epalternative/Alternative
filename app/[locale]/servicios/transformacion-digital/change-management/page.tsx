...
export default function ChangeManagementPage() {
  ...
  const faqs = [
    {
      question: isEs ? '¿Change management es necesario para todos los proyectos digitales?' : 'Is change management necessary for all digital projects?',
      answer: isEs
    ...
    {
      question: isEs ? '¿Cuándo se debe iniciar change management en un proyecto?' : 'When should change management start in a project?',
      answer: isEs
    ...
    {
      question: isEs ? '¿Alternative solo diseña plan de change o también lo ejecuta?' : 'Does Alternative only design change plan or also execute it?',
      answer: isEs
    ...
    {
      question: isEs ? '¿Cómo miden éxito de change management?' : 'How do you measure change management success?',
      answer: isEs
    ...
    {
      question: isEs ? '¿Qué hacer con personas que se niegan a adoptar el cambio?' : 'What to do with people who refuse to adopt change?',
      answer: isEs
    ...
    {
      question: isEs ? '¿Change management solo aplica a transformación digital o también a otros cambios?' : 'Does change management only apply to digital transformation or also to other changes?',
      answer: isEs
