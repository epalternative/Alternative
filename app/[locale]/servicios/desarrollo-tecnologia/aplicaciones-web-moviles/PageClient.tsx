...
export default function AplicacionesWebMovilesPage() {
  ...
  const faqs = [
    {
      question: isEs ? '¿Cuánto cuesta desarrollar app móvil o web?' : 'How much does it cost to develop mobile or web app?',
      answer: isEs
        ? 'Depende de complejidad y alcance: App simple (5-10 pantallas, funcionalidad básica, sin integraciones complejas): $15K-$35K. App mediana (15-25 pantallas, integraciones API, backend custom, login/usuarios): $35K-$80K. App compleja (30+ pantallas, funcionalidades avanzadas, AI/ML, pagos, tiempo real): $80K-$200K+. Web app: Típicamente 60-70% costo de móvil (menos testing, sin App Store). Estimamos con precisión después de discovery session donde entendemos alcance.'
