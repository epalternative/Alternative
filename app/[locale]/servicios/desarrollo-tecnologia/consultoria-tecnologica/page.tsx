...
export default function ConsultoriaTecnologicaPage() {
  ...
  const faqs = [
    {
      question: isEs ? '¿Cuánto cuesta consultoría tecnológica?' : 'How much does technology consulting cost?',
      answer: isEs
        ? 'Depende de alcance y complejidad: Consultoría puntual (arquitectura de solución, evaluación de 2-3 opciones): $10K-$25K. Consultoría completa (evaluación exhaustiva de 5+ opciones, RFP, TCO, recomendaciones): $25K-$60K. Consultoría estratégica (roadmap tecnológico 3 años, diagnóstico completo, arquitectura enterprise): $40K-$100K+. Típicamente consultoría es 5-15% del valor de inversión tecnológica que estás evaluando.'
        : 'Depends on scope and complexity: Point consulting (solution architecture, evaluation of 2-3 options): $10K-$25K. Complete consulting (exhaustive evaluation of 5+ options, RFP, TCO, recommendations): $25K-$60K. Strategic consulting (3-year technology roadmap, complete diagnosis, enterprise architecture): $40K-$100K+. Typically consulting is 5-15% of value of technology investment you\'re evaluating.'
    },
    {
      question: isEs ? '¿Consultoría solo recomienda o también ejecuta?' : 'Does consulting only recommend or also execute?',
      answer: isEs
        ? 'Ambos modelos: (1) Solo consultoría: Recomendamos, cliente ejecuta con vendor elegido o internamente. (2) Consultoría + implementación: Recomendamos Y ejecutamos con nuestro equipo de desarrollo. Modelo 2 es común cuando recomendación es desarrollo custom o integración compleja. Ventaja de Alternative: Somos consultores QUE TAMBIÉN desarrollamos, entonces recomendaciones son técnicamente viables (consultores que no desarrollan a veces recomiendan cosas imposibles de ejecutar).'
        : 'Both models: (1) Consulting only: We recommend, client executes with chosen vendor or internally. (2) Consulting + implementation: We recommend AND execute with our development team. Model 2 is common when recommendation is custom development or complex integration. Alternative advantage: We are consultants WHO ALSO develop, so recommendations are technically viable (consultants who don\'t develop sometimes recommend things impossible to execute).'
    },
    {
      question: isEs ? '¿Alternative tiene alianzas con vendors que sesgan recomendaciones?' : 'Does Alternative have vendor alliances that bias recommendations?',
      answer: isEs
        ? 'No tenemos alianzas comerciales con vendors tecnológicos (SAP, Salesforce, Microsoft, Oracle). No ganamos comisiones por recomendar proveedor específico. Nuestro modelo: Cobramos por consultoría, punto. Recomendación es puramente basada en análisis objetivo de lo mejor para tu caso. Diferencia crítica: Muchas "consultoras" son en realidad revendedoras de tecnología específica (ej: partner SAP). Nosotros no. Si recomendamos SAP es porque análisis dice que es mejor opción, no porque ganamos comisión.'
