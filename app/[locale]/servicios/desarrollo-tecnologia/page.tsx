...
export default function DesarrolloTecnologiaPage() {
  ...
  const faqs = [
    ...
    {
      question: isEs ? '¿Quién es dueño del código fuente y la solución?' : 'Who owns the source code and solution?',
      answer: isEs
    ...
    {
      question: isEs ? '¿Alternative solo desarrolla o también da consultoría estratégica tecnológica?' : 'Does Alternative only develop or also provide strategic technology consulting?',
      answer: isEs
        ? 'Ambos. Desarrollo (este servicio): Construimos la solución. Consultoría tecnológica (servicio 4): Asesoramos en decisiones estratégicas antes de desarrollar: arquitectura de solución, build vs buy, selección de tecnologías, evaluación de vendors, roadmap tecnológico. Secuencia típica: (1) Consultoría define QUÉ y CÓMO, (2) Desarrollo construye, (3) Soporte mantiene. Algunos clientes contratan solo consultoría (toman decisiones, ejecutan internamente). Mayoría contratan consultoría + desarrollo.'
