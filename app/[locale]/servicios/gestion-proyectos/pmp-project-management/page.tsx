...
export default function PMPProjectManagementPage() {
  ...
  const faqs = [
    {
      question: isEs 
        ? '¿Cuánto tiempo toma integrar un PM de Alternative a mi proyecto?' 
        : 'How long does it take to integrate an Alternative PM into my project?',
      answer: isEs
        ? 'Típicamente 3-5 días hábiles. Incluye: revisión de documentación existente, reuniones con stakeholders clave, entendimiento del contexto organizacional y diagnóstico inicial. A partir de la segunda semana ya está contribuyendo activamente a planificación o ejecución según el estado del proyecto.'
        : 'Typically 3-5 business days. Includes: review of existing documentation, meetings with key stakeholders, understanding organizational context and initial diagnosis. From the second week, they are actively contributing to planning or execution depending on project status.'
    },
    {
      question: isEs 
        ? '¿Qué pasa si el PM asignado no es compatible con mi equipo?' 
        : 'What happens if the assigned PM is not compatible with my team?',
      answer: isEs
        ? 'Garantizamos compatibilidad. Si dentro de las primeras 2 semanas identificamos que no es el fit correcto, reemplazamos al PM sin costo adicional. Esto nunca ha sucedido gracias a nuestro proceso de matching, pero la garantía existe.'
        : 'We guarantee compatibility. If within the first 2 weeks we identify it\'s not the right fit, we replace the PM at no additional cost. This has never happened thanks to our matching process, but the guarantee exists.'
    },
    {
      question: isEs 
        ? '¿El PM trabaja on-site o remoto?' 
        : 'Does the PM work on-site or remote?',
      answer: isEs
        ? 'Flexible según tu necesidad. Podemos trabajar 100% on-site, híbrido, o remoto. Para proyectos complejos con equipos distribuidos, recomendamos al menos presencia inicial para establecer relaciones y luego modelo híbrido.'
        : 'Flexible according to your needs. We can work 100% on-site, hybrid, or remote. For complex projects with distributed teams, we recommend at least initial on-site presence to establish relationships and then a hybrid model.'
    },
    {
      question: isEs 
        ? '¿Qué diferencia hay entre un PM PMP y un Scrum Master?' 
        : 'What\'s the difference between a PMP PM and a Scrum Master?',
      answer: isEs
        ? 'Un PM PMP gestiona proyectos end-to-end (alcance, tiempo, costo, calidad, riesgos) usando metodología predictiva o híbrida. Un Scrum Master facilita equipos ágiles en sprints cortos. PMP es mejor para proyectos con alcance definido, múltiples stakeholders, y entregables claros. Scrum Master es mejor para desarrollo de producto continuo.'
        : 'A PMP PM manages end-to-end projects (scope, time, cost, quality, risks) using predictive or hybrid methodology. A Scrum Master facilitates agile teams in short sprints. PMP is better for projects with defined scope, multiple stakeholders, and clear deliverables. Scrum Master is better for continuous product development.'
    },
    {
      question: isEs 
        ? '¿Pueden rescatar un proyecto que ya está en problemas?' 
        : 'Can you rescue a project that\'s already in trouble?',
      answer: isEs
        ? 'Sí, es uno de nuestros escenarios más comunes. Nuestros PMs tienen experiencia específica en recovery de proyectos. El proceso incluye: diagnóstico rápido (1 semana), plan de recuperación, renegociación de expectativas con stakeholders, y ejecución enfocada.'
        : 'Yes, it\'s one of our most common scenarios. Our PMs have specific experience in project recovery. The process includes: rapid diagnosis (1 week), recovery plan, renegotiation of expectations with stakeholders, and focused execution.'
    },
    {
      question: isEs 
        ? '¿Cuál es el modelo de contratación y precios?' 
        : 'What is the contracting model and pricing?',
      answer: isEs
        ? 'Trabajamos por mes o por proyecto. Tarifa mensual fija que incluye PM dedicado, supervisión de calidad, y reportería. No hay costos ocultos. Descuentos por contratos de 6+ meses. Cotización específica depende de complejidad del proyecto y seniority del PM requerido.'
        : 'We work per month or per project. Fixed monthly rate that includes dedicated PM, quality supervision, and reporting. No hidden costs. Discounts for 6+ month contracts. Specific quote depends on project complexity and required PM seniority.'
    }
  ];
