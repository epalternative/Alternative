...
interface MadurezIntroProps {
  onStart: () => void;
}

export function MadurezIntro({ onStart }: MadurezIntroProps) {
  ...
  const heroStats = [
    { value: '5', label: isEs ? 'minutos' : 'minutes' },
    { value: '20', label: isEs ? 'preguntas' : 'questions' },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <Button
              size="lg"
              onClick={onStart}
              className="bg-turquesa text-azul-marino hover:bg-menta font-semibold px-6 transition-all duration-300 shadow-lg shadow-turquesa/20 mb-8"
            >
              {t('intro.cta')}
            </Button>
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { label: isEs ? 'Duración' : 'Duration', value: '5 min', pct: 95 },
                  { label: isEs ? 'Preguntas' : 'Questions', value: '20', pct: 85 },
                  { label: 'Score', value: '0-100', pct: 80 },
                ].map((item, idx) => (
              ...
              <div className="mt-6 pt-6 border-t border-azul-marino/10 flex justify-between text-sm">
                <span className="text-azul-marino/60">{isEs ? 'Gratuito' : 'Free'}</span>
